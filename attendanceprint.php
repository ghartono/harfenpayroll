...
if(isset($_SESSION["username"]))
{
	...
	<tr>
		<td>
			In which Week and in what Year are you going to print?<br>
			<!-- To show what week and year is today, so that user does not need to search what week is this week -->
			Today is <?php 
					$week = date('W');
					$year = date('Y');
					echo"<b>Week: $week , Year: $year</b>";
				 ?>
		</td>
		<td>
